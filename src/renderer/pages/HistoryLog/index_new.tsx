          ...
          <div className="p-4 border-b border-white/10 flex-shrink-0">
            ...
            {error && (
              <button
                ...
                onClick={handleRetry}
                disabled={isLoading}
                className="w-full bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-xl px-4 py-3 text-blue-300 text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
                  ...
                  <div className="flex items-center justify-center py-16">
                    <div className="text-center">
                      ...
                      <button
                        type="button"
                        onClick={handleRetry}
                        className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-xl px-6 py-3 text-red-300 text-sm font-medium transition-all flex items-center gap-2 mx-auto"
                      >
                        <span>🔄</span>
                        <span>重新连接</span>
                      </button>
              ...
              <div className="text-center">
                ...
                {error && (
                  <button
                    ...
                    onClick={handleRetry}
                    disabled={isLoading}
                    className="bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-xl px-6 py-3 text-blue-300 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3 mx-auto"
                  >
                    {isLoading ? (
                      <>
                        <div className="w-4 h-4 border-2 border-blue-300/30 border-t-blue-300 rounded-full animate-spin" />
